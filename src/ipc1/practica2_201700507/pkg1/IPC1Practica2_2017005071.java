 ...
 * @author kimel
 */
public class IPC1Practica2_2017005071 extends JFrame{
...
//                System.out.println("Disparo");
    ...
    public IPC1Practica2_2017005071(){
        ...
        timerCrearEnemigos.scheduleAtFixedRate(timerCreacionEnemigos, 0, 2000);
...
//                    System.out.println("Colision Enemigo!!!!!!!!!!!!!!!!!!!!!!");
    ...
    public void generarEnemigos(){
        ...
        }else{System.out.println("Ya no hay lugares disponibles...");}
...
//                    System.out.println("Colision " + i);
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawString("Tiempo: ", 30, 80);
        g.drawString("Puntos: " + navePrincipal.getPuntos(), 200, 80);
        g.drawString("Enemigos muertos: " + contadorEnemigoDisparo, 200, 100);
